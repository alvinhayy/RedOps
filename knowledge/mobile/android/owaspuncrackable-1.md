...
source_url: https://hacktricks.wiki/mobile-pentesting/android-app-pentesting/frida-tutorial/owaspuncrackable-1.html
...
`frida-trace` (Frida ≥ 16)
If you do not want to hand-write hooks, let **Frida** generate Java stubs and then edit them:[\[2\]](#references)
...
Objection wraps Frida and provides commands for watching methods and changing return values. Command names vary between Objection releases, so confirm the syntax with `help` in the installed version.[\[3\]](#references)
