...
source_url: https://hacktricks.wiki/mobile-pentesting/ios-pentesting/itunesstored-bookassetd-sandbox-escape.html
...
### [Malicious `asset` row](#malicious-asset-row)
...
## [Crafting the EPUB Payload](#crafting-the-epub-payload)

`bookassetd` respects the EPUB ZIP format: `mimetype` must be the first uncompressed entry. To map EPUB contents to the MobileGestalt cache, build a directory tree that mirrors the desired path relative to `ZPLISTPATH`.[\[1\]](#references)
...
## [Tooling & Operational Notes](#tooling--operational-notes)
...
- **Public PoC** –[https://github.com/hanakim3945/bl_sbx](https://github.com/hanakim3945/bl_sbx) ships baseline SQLite/EPUB templates you can customize.<sup>[\[2\]](#references)</sup>

## [Detection & Mitigation Ideas](#detection--mitigation-ideas)
