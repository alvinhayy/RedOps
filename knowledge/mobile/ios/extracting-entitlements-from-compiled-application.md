...
source_url: https://hacktricks.wiki/mobile-pentesting/ios-pentesting/extracting-entitlements-from-compiled-application.html
...
```
Both Binwalk and radare2 can locate embedded property-list text. In this Telegram example, the first XML object at `0x0015d2a4` corresponds to the project’s entitlement file.[\[3\]](#references)
