...
source_url: https://hacktricks.wiki/windows-hardening/authentication-credentials-uac-and-efs.html
...
Mimikatz can import the user’s certificate and private key, then use them to decrypt EFS-protected files.[\[2\]](#references)

[howto ~ decrypt EFS files \xc2\xb7 gentilkiwi/mimikatz Wiki \xc2\xb7 GitHub](https://github.com/gentilkiwi/mimikatz/wiki/howto-~-decrypt-EFS-files)
...
```
In current Windows that Bypass won’t work but you can use [**PSByPassCLM**](https://github.com/padovah4ck/PSByPassCLM).**To compile it you may need** **to** ***Add a Reference*** -> *Browse* ->*Browse* -> add `C:\Windows\Microsoft.NET\assembly\GAC_MSIL\System.Management.Automation\v4.0_3.0.0.0\31bf3856ad364e35\System.Management.Automation.dll` and **change the project to .Net4.5**.
