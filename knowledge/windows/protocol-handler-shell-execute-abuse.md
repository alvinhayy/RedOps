...
source_url: https://hacktricks.wiki/windows-hardening/protocol-handler-shell-execute-abuse.html
...
- Dangerous example schemes:<sup>[\[1\]](#references)</sup>  - `file://` to launch a local/UNC payload.
