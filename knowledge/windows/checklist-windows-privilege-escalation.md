...
source_url: https://hacktricks.wiki/windows-hardening/checklist-windows-privilege-escalation.html
...
-  [**Third-party agent auto-updaters / IPC abuse**](windows-local-privilege-escalation/abusing-auto-updaters-and-ipc.html)
...
-  [**Admin Protection / UIAccess silent elevation**](windows-local-privilege-escalation/uiaccess-admin-protection-bypass.html) ?<sup>[\[1\]](#references)</sup>
-  [**Secure Desktop accessibility registry propagation (RegPwn)**](windows-local-privilege-escalation/secure-desktop-accessibility-registry-propagation-regpwn.html) ?<sup>[\[2\]](#references)</sup>
...
-  Check if you have [**SeManageVolumePrivilege**](windows-local-privilege-escalation/semanagevolume-perform-volume-maintenance-tasks.html) to read raw volumes and bypass file ACLs
...
-  If [**SeManageVolumePrivilege**](windows-local-privilege-escalation/semanagevolume-perform-volume-maintenance-tasks.html) is present, try raw-volume reads for`SAM` ,`SYSTEM` , DPAPI material, and`MachineKeys`
