...
source_url: https://hacktricks.wiki/binary-exploitation/libc-heap/house-of-rabbit.html
...
**Objective**: Create an overlapping chunk by manipulating the size of a fastbin chunk.[\[1\]](#references)[\[2\]](#references)
...
`fd` pointer
**Objective**: Create a fake chunk by manipulating the fast bin `fd` pointer.[\[1\]](#references)[\[2\]](#references)
...
- [3] [how2heap — allocator techniques by glibc version](https://github.com/shellphish/how2heap)
