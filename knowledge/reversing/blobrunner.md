...
source_url: https://hacktricks.wiki/reversing/reversing-tools-basic-methods/blobrunner.html
...
```
For complementary workflows such as **jmp2it**, **Cutter** emulation, or **scdbg**-based shellcode tracing, check the [parent shellcode reversing page](README.html).
