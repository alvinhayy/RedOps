...
source_url: https://hacktricks.wiki/reversing/reversing-tools-basic-methods/cheat-engine.html
...
Cheat Engine will search for the **values** that **went from 100 to the new value**. Congrats, you **found** the **address** of the value you were looking for, you can now modify it.*If you still have several values, do something to modify again that value, and perform another “next scan” to filter the addresses.*
...
```
For the Frida bridge see `bb33bb/frida-ceserver` on GitHub.[\[1\]](#references)[\[2\]](#references)
