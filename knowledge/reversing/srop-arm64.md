...
source_url: https://hacktricks.wiki/binary-exploitation/rop-return-oriented-programing/srop-sigreturn-oriented-programming/srop-arm64.html
...
`rt_sigreturn` on ARM64 (2023-2025)
...
```
This is much more reliable than grepping the main binary because on ARM64 the **SROP entry point usually lives in the vDSO**, not in the target ELF itself.[\[1\]](#references)
