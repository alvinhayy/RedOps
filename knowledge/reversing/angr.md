...
source_url: https://hacktricks.wiki/reversing/reversing-tools-basic-methods/angr/index.html
...
True
```
Furthermore, you can use `proj.hook_symbol(name, hook)`, providing the name of a symbol as the first argument, to hook the address where the symbol lives[\[1\]](#references)
