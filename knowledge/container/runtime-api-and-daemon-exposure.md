...
source_url: https://hacktricks.wiki/linux-hardening/containers-namespaces/container-security/runtime-api-and-daemon-exposure.html
...
A mounted `containerd` socket is usually just as dangerous:[\[1\]](#references)
