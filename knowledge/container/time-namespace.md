...
source_url: https://hacktricks.wiki/linux-hardening/containers-namespaces/container-security/protections/namespaces/time-namespace.html
...
Time namespaces are slightly unusual compared to mount, PID, or network namespaces:[\[1\]](#references)
...
Checkpoint/restore stacks such as CRIU are one of the main real-world reasons this exists at all. Without time namespaces, restoring a paused workload would make monotonic and boot-time clocks jump by the amount of time the workload spent suspended.[\[2\]](#references)
