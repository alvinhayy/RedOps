...
source_url: https://hacktricks.wiki/network-services-pentesting/11211-memcache/memcache-commands.html
...
**From** **https://lzone.de/cheat-sheet/memcached**[\[1\]](#references)
...
Ensure to use \r\n als line breaks when using Unix CLI tools. For example`set mykey`
