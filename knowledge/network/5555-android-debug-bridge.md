...
source_url: https://hacktricks.wiki/network-services-pentesting/5555-android-debug-bridge.html
...
Android Debug Bridge (adb) is a command-line tool to communicate with Android-based devices and emulators. Typical actions include installing packages, debugging, and getting an interactive Unix shell on the device.[\[1\]](#references)

- Historical default TCP port: 5555 (classic “adb tcpip” mode).
- Modern Wireless debugging (Android 11+) uses TLS pairing and mDNS service discovery. The connect port is dynamic and discovered via mDNS; it may not be 5555. Pairing is done with adb pair host:port followed by adb connect. See the notes below for offensive implications.<sup>[\[2\]](#references)</sup>
...
Modern Android implements TLS-protected wireless debugging with device-side pairing and mDNS discovery:[\[2\]](#references)
...
- [2] [AOSP – ADB over Wi‑Fi, pairing and mDNS service names](https://android.googlesource.com/platform/packages/modules/adb/+/refs/tags/android-vts-15.0_r2/docs/dev/adb_wifi.md)
