...
source_url: https://hacktricks.wiki/pentesting-web/rate-limit-bypass.html
...
PortSwigger’s GraphQL testing guidance demonstrates the alias-based rate-limit bypass.[\[2\]](#references)
