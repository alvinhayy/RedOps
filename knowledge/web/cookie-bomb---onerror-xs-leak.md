...
source_url: https://hacktricks.wiki/pentesting-web/xs-search/cookie-bomb-+-onerror-xs-leak.html
...
- This class of attacks is discussed broadly as “Error Events” XS-Leaks.<sup>[\[7\]](#references)</sup> The cookie-bomb step is just a convenient way to push only one branch over server limits, producing a reliable boolean oracle.
