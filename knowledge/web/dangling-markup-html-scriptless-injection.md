...
source_url: https://hacktricks.wiki/pentesting-web/dangling-markup-html-scriptless-injection/index.html
...
This technique can extract information from a user’s page when **HTML injection** is possible but direct [**XSS**](../xss-cross-site-scripting/index.html) is not. It is useful when a **secret appears in clear text** later in the HTML or when injected markup can disrupt an existing script workflow.[\[1\]](#references)[\[2\]](#references)[\[3\]](#references)
...
Find an [**example of this attack in this writeup**](https://portswigger.net/research/stealing-passwords-from-infosec-mastodon-without-bypassing-csp).[\[5\]](#references)
...
You can find detailed **research** on exploitable vulnerabilities of the <portal tag in [this archived article](https://web.archive.org/web/20260000000000id_/https://research.securitum.com/security-analysis-of-portal-element/).[\[7\]](#references)
...
Not every HTML connectivity leak works as dangling markup, but the HTTPLeaks corpus contains additional elements and attributes worth testing.[\[8\]](#references)
...
[https://github.com/carlospolop/Auto_Wordlists/blob/main/wordlists/dangling_markup.txt](https://github.com/carlospolop/Auto_Wordlists/blob/main/wordlists/dangling_markup.txt)
