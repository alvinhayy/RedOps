...
source_url: https://hacktricks.wiki/pentesting-web/deserialization/java-transformers-to-rutime-exec-payload.html
...
Java deserialization payloads commonly use transformers from Apache Commons Collections, as in the following example.[\[1\]](#references)
