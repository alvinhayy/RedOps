...
source_url: https://hacktricks.wiki/pentesting-web/xss-cross-site-scripting/shadow-dom.html
...
- `mode: "closed"` only hides the root from`element.shadowRoot` ; code running in the same JS realm can still intercept its creation.<sup>[\[1\]](#references)</sup>
...
```
Important parsing behavior for exploitation:[\[2\]](#references)[\[4\]](#references)
...
A good lab for this topic is the DiceCTF `shadow` challenge, which chained DOM XSS with closed-shadow-root abuse and CSS-based extraction ideas.[\[5\]](#references)

## References

- [1] [The Closed Shadow DOM](https://blog.ankursundara.com/shadow-dom/)
- [2] [Declarative Shadow DOM explainer](https://github.com/mfreed7/declarative-shadow-dom/blob/master/README.md)
- [3] [MDN — Using shadow DOM](https://developer.mozilla.org/en-US/docs/Web/API/Web_components/Using_shadow_DOM)
- [4] [MDN — `Element.setHTMLUnsafe()`](https://developer.mozilla.org/en-US/docs/Web/API/Element/setHTMLUnsafe)
- [5] [DiceCTF `shadow` challenge writeup](https://github.com/Super-Guesser/ctf/blob/master/2022/dicectf/shadow.md)
