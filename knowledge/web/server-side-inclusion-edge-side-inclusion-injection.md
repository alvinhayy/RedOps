...
source_url: https://hacktricks.wiki/pentesting-web/server-side-inclusion-edge-side-inclusion-injection.html
...
**(Introduction taken from** **Apache docs****)**[\[1\]](#references)
...
```
- Steal cookie HTTP_ONLY with XSS by reflecting it in the response:<sup>[\[4\]](#references)</sup>
...
- Add header in forced request<sup>[\[3\]](#references)</sup>
...
```
- Add header in response (useful to bypass “Content-Type: text/json” in a response with XSS)<sup>[\[4\]](#references)</sup>
...
[https://github.com/carlospolop/Auto_Wordlists/blob/main/wordlists/ssi_esi.txt](https://github.com/carlospolop/Auto_Wordlists/blob/main/wordlists/ssi_esi.txt)
