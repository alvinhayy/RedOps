...
source_url: https://hacktricks.wiki/windows-hardening/active-directory-methodology/over-pass-the-hash-pass-the-key.html
...
The process can be initiated with the following commands:[\[1\]](#references)
...
```
For scenarios necessitating AES256, the `-aesKey [AES key]` option can be utilized:[\[1\]](#references)
...
An alternative command sequence using Rubeus.exe demonstrates another facet of this technique:[\[1\]](#references)
