...
source_url: https://hacktricks.wiki/AI/AI-Supervised-Learning-Algorithms.html
...
1.
**Load the dataset** (download via URL if available).
2.
**Preprocess the data** (e.g. encode categorical features, scale values, split into train/test sets).
3.
**Train the model** on the training data.
4.
**Evaluate** on a test set using metrics: accuracy, precision, recall, F1-score, and ROC AUC for classification (and mean squared error for regression).
...
#### [Logistic Regression for non binary classification](#logistic-regression-for-non-binary-classification)
...
#### [**Key characteristics of Logistic Regression:**](#key-characteristics-of-logistic-regression)
...
#### [**Key characteristics of Decision Trees:**](#key-characteristics-of-decision-trees)
...
#### [**Key characteristics of SVM:**](#key-characteristics-of-svm)
...
| **Decision boundary** | Finds the **best‑fit hyperplane** that models*P(y\|x)* . | Finds the **maximum‑margin hyperplane** (largest gap to the closest points). |
...
#### [**Key characteristics of k-NN:**](#key-characteristics-of-k-nn)
...
#### [**Key characteristics of Gradient Boosting:**](#key-characteristics-of-gradient-boosting)
...
The neural-network approaches described in the [deep-learning page](AI-Deep-Learning.html) can complement these classical models for intrusion detection when the dataset and compute budget justify the additional complexity.[\[13\]](#references)
