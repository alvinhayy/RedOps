...
source_url: https://hacktricks.wiki/todo/rust-basics.html
...
Most real-world Rust vulns live in third-party crates. The RustSec advisory DB (community-powered) can be queried locally:[\[1\]](#references)
...
```
The tool is being adopted by the Rust project infrastructure and a growing number of orgs to mitigate poisoned-package attacks.[\[2\]](#references)
