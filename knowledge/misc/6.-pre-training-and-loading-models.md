...
source_url: https://hacktricks.wiki/AI/AI-llm-architecture/6.-pre-training-and-loading-models.html
...
- The **optimizer** to use during training: This is the function that will use the gradients and will update the parameters to reduce the loss. In this case, as you will see,`AdamW` is used, but there are many more.
  ...
  - Traditional optimizers like SGD with L2 regularization couple weight decay with the gradient of the loss function. However,
