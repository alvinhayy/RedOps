---
title: "Operational Privacy Playbooks"
source: hacktricks.wiki
source_url: https://hacktricks.wiki/privacy/operational-privacy-playbooks.html
...
Use the detailed model in [Threat Modeling and Identity Separation](threat-modeling-and-identity-separation.html).
...
See [Authorized Red-Team Infrastructure](authorized-red-team-infrastructure.html) for the full build and teardown guide.
...
See [Private Digital Payments](private-digital-payments.html) and [Cryptocurrency Privacy](cryptocurrency-privacy.html).
...
The comparison and setup details are in [Network Privacy and Anonymous Connectivity](network-privacy-and-anonymous-connectivity.html).
