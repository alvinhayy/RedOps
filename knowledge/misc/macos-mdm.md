...
source_url: https://hacktricks.wiki/macos-hardening/macos-red-teaming/macos-mdm/index.html
...
It follows a few steps to get the Activation Record performed by **`MCTeslaConfigurationFetcher`**. This process uses an encryption called **Absinthe**[\[1\]](#references)
...
3. Uses various device-specific data (i.e.
4. Retrieve **session key**
5. Establish the session (**`NACKeyEstablishment`** )
6. Make the request
...
Therefore, this could be a dangerous entrypoint for attackers if the enrolment process isn’t correctly protected:[\[2\]](#references)

[Enrolling Devices in Other Organisations](enrolling-devices-in-other-organisations.html)
