---
title: "Attribution, Detection and Countermeasures"
source: hacktricks.wiki
source_url: https://hacktricks.wiki/privacy/attribution-detection-and-countermeasures.html
...
Mandiant recommends tracking ORB infrastructure as an evolving entity because short-lived IP blocking does not capture topology and lifecycle.[\[1\]](#references)
...
FATF’s red flags are explicitly contextual: unusual pattern, amount/frequency, geography, source of funds and anonymity-enhancing services become meaningful together.[\[5\]](#references)
