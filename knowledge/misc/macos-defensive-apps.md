...
source_url: https://hacktricks.wiki/macos-hardening/macos-security-and-privilege-escalation/macos-defensive-apps.html
...
- [**ProcessMonitor / FileMonitor / DNSMonitor**](https://objective-see.org/products/utilities.html) : Lightweight Objective-See tools for**process** ,**file** , and**DNS** telemetry. On modern macOS they have extra prerequisites such as**root** ,**Terminal Full Disk Access** , or**System/Network Extension approval** . For more instrumentation ideas check[this other page about macOS app inspection/debugging](macos-apps-inspecting-debugging-and-fuzzing/README.html) .
