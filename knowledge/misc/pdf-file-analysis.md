...
source_url: https://hacktricks.wiki/generic-methodologies-and-resources/basic-forensic-methodology/specific-software-file-type-tricks/pdf-file-analysis.html
...
The examples below use the documented `pdf-parser.py`, qpdf, and pdfcpu command-line interfaces.[\[7\]](#references)[\[9\]](#references)[\[10\]](#references)
