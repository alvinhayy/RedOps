...
source_url: https://hacktricks.wiki/hardware-physical-access/firmware-analysis/synology-encrypted-archive-decryption.html
...
```
`synodecrypt` automatically detects PAT/SPK, loads the correct keys and applies the full chain described above.[\[2\]](#references)
