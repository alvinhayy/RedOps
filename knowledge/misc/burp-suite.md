...
source_url: https://hacktricks.wiki/todo/burp-suite.html
...
Burp Intruder includes the following built-in payload generators and transformations:[\[1\]](#references)
