---
title: "KYC Bypass Using AI"
source: hacktricks.wiki
source_url: https://hacktricks.wiki/AI/KYC-Bypass-Using-AI.html
...
Native mobile apps can raise the attacker’s cost with:[\[1\]](#references)
...
When reviewing a KYC or liveness integration, verify whether it:[\[1\]](#references)
