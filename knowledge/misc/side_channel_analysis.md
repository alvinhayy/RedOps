...
source_url: https://hacktricks.wiki/todo/hardware-hacking/side_channel_analysis.html
...
Observe a *single* trace and associate visible features with operations such as branches, modular multiplication, or different instruction sequences.[\[1\]](#references)

The exact setup is target-specific. The following uses the current high-level ChipWhisperer capture API after the scope and target have been connected and configured:[\[1\]](#references)
