...
source_url: https://hacktricks.wiki/macos-hardening/macos-security-and-privilege-escalation/macos-files-folders-and-binaries/macos-bundles.html
...
Before Ventura, swapping UI resources in a signed app could bypass shallow code signing and yield code execution with the app’s entitlements. Current research (2024) shows this still works on pre-Ventura and on unquarantined builds:[\[1\]](#references)[\[2\]](#references)
