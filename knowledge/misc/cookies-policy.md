...
source_url: https://hacktricks.wiki/todo/cookies-policy.html
...
Moreover, the pages book.hacktricks.wiki and cloud.hacktricks.wiki are hosted by GitBook. GitBook documents the cookies used by its visitor-authentication and analytics features in its privacy documentation.[\[1\]](#references)
