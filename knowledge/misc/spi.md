...
source_url: https://hacktricks.wiki/todo/hardware-hacking/spi.html
...
```
Recent Bus Pirate documentation also shows optional `serialspeed` and `spispeed` parameters. Start conservatively if long wires or in-circuit loading make reads unstable.[\[3\]](#references)
