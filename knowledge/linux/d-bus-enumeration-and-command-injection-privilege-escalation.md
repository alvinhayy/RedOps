...
source_url: https://hacktricks.wiki/linux-hardening/processes-crontab-systemd-dbus/d-bus-enumeration-and-command-injection-privilege-escalation.html
...
```
See the [D-Bus documentation](http://dbus.freedesktop.org/doc/dbus-specification.html) for more information on match rule syntax.[\[7\]](#references)
...
Keeping an eye on recently published CVEs helps spotting similar insecure patterns in custom code. Two good recent examples are:[\[2\]](#references)[\[3\]](#references)
